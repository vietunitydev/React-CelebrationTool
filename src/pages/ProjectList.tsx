...
import { getProjects, addProject, deleteProject, updateProject } from '../utils/storage';
...
const ProjectList: React.FC = () => {
    ...
    const handleSaveEdit = () => {
        if (editingProject && editedName.trim()) {
            const updatedProject = { ...editingProject, name: editedName.trim() };
    ...
    return (
        <div>
            ...
            {showForm && (
                <form onSubmit={handleAddProject} className="mb-6 bg-white p-4 rounded-md shadow">
                    <h2 className="text-lg font-medium text-gray-900 mb-3">Thêm môn học mới</h2>
                    <div className="flex">
                        <input
                            type="text"
            ...
            {projects.length === 0 ? (
                <div className="text-center py-12 bg-white rounded-md shadow">
                    ...
                    <h3 className="mt-2 text-lg font-medium text-gray-900">Chưa có môn học nào</h3>
                    <p className="mt-1 text-sm text-gray-500">Hãy tạo môn học đầu tiên để bắt đầu.</p>
                    <div className="mt-6">
                        <button
                            onClick={() => setShowForm(true)}
                                ...
                                <>
                                    <div className="p-4">
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">
                                            {project.lessons.length} bài học
                                        </p>
                                    </div>
                                    <div className="bg-gray-50 px-4 py-3 flex justify-between">
                                        ...
                                        <Link
                                            to={`/vocab-test/project/${project.id}`}
